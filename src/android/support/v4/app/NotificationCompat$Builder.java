...
label0:
    ...
    public mContentTitle setAutoCancel(boolean flag)
    {
        setFlag(16, flag);
        return this;
    }
    ...
    public mCategory setChannel(String s)
    {
        mChannelId = s;
        return this;
    }

    public mChannelId setColor(int i)
    {
        mColor = i;
        return this;
    }
    ...
    public limitCharSequenceLength setCustomBigContentView(RemoteViews remoteviews)
    {
        mBigContentView = remoteviews;
        return this;
    }

    public mBigContentView setCustomContentView(RemoteViews remoteviews)
    {
        mContentView = remoteviews;
        return this;
    }

    public mContentView setCustomHeadsUpContentView(RemoteViews remoteviews)
    {
        mHeadsUpContentView = remoteviews;
        return this;
    }

    public mHeadsUpContentView setDefaults(int i)
    {
    ...
    public mPublicVersion setRemoteInputHistory(CharSequence acharsequence[])
    {
        mRemoteInputHistory = acharsequence;
        return this;
    }

    public mRemoteInputHistory setShowWhen(boolean flag)
    {
        mShowWhen = flag;
        return this;
    }
