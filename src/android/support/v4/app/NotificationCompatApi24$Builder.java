    ...
    implements NotificationBuilderWithBuilderAccessor, NotificationBuilderWithActions
{
    ...
    private android.app._cls24.Builder.b b;

    public void addAction(cessor cessor)
    {
        NotificationCompatApi24.addAction(b, cessor);
    }
    ...
    public android.app._cls24.Builder getBuilder()
    {
        return b;
    }
    ...
    {
        context = (new android.app._cls24.Builder(context)).Builder(notification.when).(flag1).n(notification.icon, notification.iconLevel).n(notification.contentView).n(notification.tickerText, remoteviews).n(notification.sound, notification.audioStreamType).n(notification.vibrate).n(notification.ledARGB, notification.ledOnMS, notification.ledOffMS);
        ...
        b = context.enIntent(pendingintent1, flag1).n(bitmap).n(i).nometer(flag2).(l).(j, k, flag).y(flag3).y(bundle).y(s1).mary(flag4).mary(s2).(s).(i1).ty(j1).rsion(notification1).putHistory(acharsequence);
        if (remoteviews1 != null)
        {
            b.ntentView(remoteviews1);
        }
        if (remoteviews2 != null)
        {
            b.gContentView(remoteviews2);
        }
        if (remoteviews3 != null)
        {
            b.adsUpContentView(remoteviews3);
        }
