    ...
    implements mCancelLabel
{
    ...
    public mConfirmLabel setHintDisplayActionInline(boolean flag)
    {
        setFlag(4, flag);
        return this;
    }

    public setFlag setHintLaunchesActivity(boolean flag)
    {
        setFlag(2, flag);
        return this;
    }

    public setFlag setInProgressLabel(CharSequence charsequence)
    {
