...
static class  extends 
{
    ...
    {
        return (getExtras)NotificationCompatApi20.getAction(notification, i, getExtras, RemoteInput.FACTORY);
    }

    public getExtras[] getActionsFromParcelableArrayList(ArrayList arraylist)
    {
        return (getExtras[])(getExtras[])NotificationCompatApi20.getActionsFromParcelableArrayList(arraylist, eArrayList, RemoteInput.FACTORY);
    }
