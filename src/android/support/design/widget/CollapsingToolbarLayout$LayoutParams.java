...
public static class mParallaxMult extends android.widget.t.LayoutParams
{
    ...
    public mParallaxMult(Context context, AttributeSet attributeset)
    {
        ...
        mCollapseMode = context.getInt(android.support.design.ayout_layout_collapseMode, 0);
        setParallaxMultiplier(context.getFloat(android.support.design.ayout_layout_collapseParallaxMultiplier, 0.5F));
        context.recycle();
    }

    public ayout_collapseParallaxMultiplier(android.view.out.LayoutParams layoutparams)
    {
        super(layoutparams);
        mCollapseMode = 0;
        mParallaxMult = 0.5F;
