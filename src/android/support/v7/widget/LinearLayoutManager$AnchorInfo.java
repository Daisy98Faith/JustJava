...
_L5:
    ...
    boolean isViewValidAsAnchor(View view, mCoordinate mcoordinate)
    {
        view = (mCoordinate)view.getLayoutParams();
        return !view.mRemoved() && view.ewLayoutPosition() >= 0 && view.ewLayoutPosition() < mcoordinate.();
    }
