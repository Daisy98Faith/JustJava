...
private class resetGroup
{
    ...
    private void setItem(MenuItem menuitem)
    {
        ...
        if (itemListenerMethodName != null)
        {
            ...
            menuitem.setOnMenuItemClickListener(new MenuItemClickListener(getRealOwner(), itemListenerMethodName));
        }
    ...
    {
        attributeset = mContext.obtainStyledAttributes(attributeset, android.support.v7.appcompat.dded);
    ...
    {
        attributeset = mContext.obtainStyledAttributes(attributeset, android.support.v7.appcompat.enabled);
        ...
        itemContentDescription = attributeset.getText(android.support.v7.appcompat.scription);
        itemTooltipText = attributeset.getText(android.support.v7.appcompat.xt);
        attributeset.recycle();
        itemAdded = false;
    }
